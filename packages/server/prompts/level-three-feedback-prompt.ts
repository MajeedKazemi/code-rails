...
Then, look back at the [student-code] and annotate each line in [fixed-student-cide] with [[correct]] and those that needed to be edited with either [[change]], [[remove]], or [[fix]] and a description about why and how. If a line must be added do the same by tagging it with [[add]] and an explanation of it.
