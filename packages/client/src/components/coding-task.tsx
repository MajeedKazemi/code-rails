                ...
                <section className="flex-auto task-info max-w-lg">
                    ...
                    <div className="task-submission-buttons-container">
                        ...
                        {showFeedback && <div className="flex flex-col gap-2">
                            {/* <button onClick={handleTaskFeedback} type="button" className="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Regenerate</button> */}
                            <Feedback 
                                feedback={autoGeneratedFeedback}
                                iteration={feedbackIteration}
                            />
                            {autoGeneratedFeedback.hasOwnProperty("explanation") && ((!incorrectAnswer || feedbackIteration >= 3) ? 
                                <Button
                                    class={blink ? "btn-attention" : ""}
