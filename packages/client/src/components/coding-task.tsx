...
export const CodingTask = (props: CodingTaskProps) => {
    ...
    const generateTitles = () => {
        apiGetTitles(context?.token, props.taskId, candidateTitles, theme)
            .then(async (response) => {
                const data = await response.json();
                    ...
                    <div className="task-description-container">
                        {customTask.title ?
                            <>
                                ...
                                <span className={"task-subtitle flex flex-col gap-2 overflow-y-auto" + (autoGeneratedFeedback.hasOwnProperty("type") ? " max-h-72" : "")}>
                                    <p
